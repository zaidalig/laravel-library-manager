...
<aside class="sidebar" id="sidebar">
    <div class="brand"><i class="fa-solid fa-book-open"></i><span>Library</span></div>
    <ul class="nav-list">
        ...
        @can('manage-library')
        <li class="nav-item"><a href="{{ route('books.index') }}" class="nav-link {{ request()->routeIs('books.*')?'active':'' }}"><i class="fa-solid fa-book"></i><span>Books</span></a></li>
